...
/*********************************************************************
 ...
 2. Graphics LCD Controller PICtail Plus SSD1926 Board
    http://www.microchip.com/AC164127-5
 3. Graphics Display Powertip 4.3in. 480x272 Board
    http://www.microchip.com/AC164127-6
*********************************************************************/
...
#define RESISTIVETOUCH_PRESS_THRESHOLD 475
...
#define EPMPCS1_DATA_WAIT_TIME  (82)
...
*********************************************************************/
#define DRV_NVM_SST25_ChipSelectEnable()   (LATDbits.LATD1 = 0)
#define DRV_NVM_SST25_ChipSelectDisable()  (LATDbits.LATD1 = 1)

#define NVM_SST26_ChipSelectEnable()   (LATDbits.LATD1 = 0)
#define NVM_SST26_ChipSelectDisable()  (LATDbits.LATD1 = 1)
...
#define RESISTIVETOUCH_ADC_XPOS             11
#define RESISTIVETOUCH_ADC_YPOS             10

#define RESISTIVETOUCH_ADPCFG_XPOS          ANSBbits.ANSB11
#define RESISTIVETOUCH_ADPCFG_YPOS          ANSBbits.ANSB10

#define RESISTIVETOUCH_ANALOG               0
#define RESISTIVETOUCH_DIGITAL              1

// X port definitions
#define RESISTIVETOUCH_XP_Signal            LATBbits.LATB11
#define RESISTIVETOUCH_XM_Signal            LATDbits.LATD9
#define RESISTIVETOUCH_XP_Direction         TRISBbits.TRISB11
#define RESISTIVETOUCH_XM_Direction         TRISDbits.TRISD9

// Y port definitions
#define RESISTIVETOUCH_YP_Signal            LATBbits.LATB10
#define RESISTIVETOUCH_YM_Signal            LATDbits.LATD8
#define RESISTIVETOUCH_YP_Direction         TRISBbits.TRISB10
#define RESISTIVETOUCH_YM_Direction         TRISDbits.TRISD8
...
#define NVMSectorErase                  NVMSectorEraseFunction
#define NVMWrite                        NVMWriteFunction
#define NVMRead                         NVMReadFunction
...
#define DataChipErase                  ((FLASH_CHIPERASE_FUNC)NVMChipEraseFunction)
#define DataWrite                      ((FLASH_WRITE_FUNC    )NVMWriteFunction)
#define DataRead                       ((FLASH_READ_FUNC     )NVMReadFunction)
