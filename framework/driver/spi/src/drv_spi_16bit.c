...
*/
#define DRV_SPI_STAT(i)      SPI##i##STATL
#define DRV_SPI_STATbits(i)  SPI##i##STATLbits
...
#define DRV_SPI_BUF(i)       SPI##i##BUFL
...
void DRV_SPI_Initialize(DRV_SPI_INIT_DATA *pData)
{
    ...
    if (pData->channel == 2)
    {
       ...
       // DRV_SPI_CONbits(2).PPRE= pData->primaryPrescale;
        ...
        DRV_SPI_CONbits(2).SPIEN = SPI_MODULE_ENABLE;
    #endif
        return;
    }
