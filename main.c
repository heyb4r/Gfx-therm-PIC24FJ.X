...
int main(void)
{
    ...
    {   
       ...
       // GFX_GOL_ButtonCreate(ID_BTN1, 20, 160, 150, 210,0,DRAW_BUTTON_START,NULL, NULL,"LEFT", GFX_ALIGN_CENTER, NULL);
...
bool APP_ObjectDrawCallback(void)
{
        GFX_GOL_OBJ_SCHEME pScheme;
            ...
            pAppFont              = (GFX_RESOURCE_HDR*)&Font25;
    ...
    GFX_GOL_SchemeEmbossSet(&pScheme,
                            WHITE,
                            WHITE,
                            3);

    GFX_GOL_SchemeFontSet(&pScheme, pAppFont);
    GFX_GOL_SchemeBackgroundColorSet(&pScheme, BLACK);
